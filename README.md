...
## 1.1. Running the project locally
...
### 1.2.2 clean docker-compose run
...
### 1.2.3 docker-compose stop vs docker-compose down
...
## 2.2. Testing with docker-compose
